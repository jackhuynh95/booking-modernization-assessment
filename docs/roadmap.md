...
Start Group 3: Final Submission Packaging:

- draft the six-page PDF content from source docs;
- compress architecture, API, events, reliability, observability, and AI declaration into reviewer-readable tables/diagrams;
- ensure assumptions and non-goals are explicit;
- prepare submission email wording.
